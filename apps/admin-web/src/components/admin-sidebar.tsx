...
const menuCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/security/secret-rotation", label: "Secret Rotation", icon: Shield },
      { href: "/admin/security/runtime", label: "Runtime Hardening", icon: Activity },
      { href: "/admin/security/rate-limits", label: "Rate Limit Overview", icon: BarChart3 },
      { href: "/admin/security/queue", label: "Queue Security", icon: Server },
      { href: "/admin/security/vulnerabilities", label: "Vulnerability Dashboard", icon: Shield },
      { href: "/admin/security/release-attestations", label: "Release Attestations", icon: Layers },
      { href: "/admin/security/environment-checks", label: "Environment Checks", icon: Settings },
      { href: "/admin/security/data-classification", label: "Data Classification", icon: Database },
      { href: "/admin/security/retention-policies", label: "Retention Policies", icon: Clock },
      { href: "/admin/security/deletion-requests", label: "Deletion Requests", icon: FileText },
      { href: "/admin/security/privacy-exports", label: "Privacy Exports", icon: FileText },
      { href: "/admin/security/cleanup-dry-runs", label: "Cleanup Dry Runs", icon: Activity },
      { href: "/admin/security/legal-holds", label: "Legal Hold Blocks", icon: Shield },
      { href: "/admin/security/supply-chain-governance", label: "Supply-Chain History", icon: Layers },
      { href: "/admin/security/compliance-audit", label: "Compliance Audit Explorer", icon: BarChart3 },
