...
CREATE TABLE IF NOT EXISTS training_runs (
  ...
  training_dataset_id uuid REFERENCES training_datasets(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS model_registry_entries (
  ...
  league_id uuid REFERENCES "League"(id) ON DELETE SET NULL,
  scope_league_key text NOT NULL DEFAULT 'global',
  model_version_id uuid NOT NULL REFERENCES "ModelVersion"(id) ON DELETE CASCADE,
  calibration_version_id uuid REFERENCES "PredictionCalibration"(id) ON DELETE SET NULL,
  feature_set_version text,
  training_dataset_id uuid REFERENCES training_datasets(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS calibration_aliases (
  ...
  scope_league_key text NOT NULL DEFAULT 'global',
  alias_type "ServingAliasType" NOT NULL,
  calibration_version_id uuid NOT NULL REFERENCES "PredictionCalibration"(id) ON DELETE CASCADE,
  is_active boolean NOT NULL DEFAULT true,
  effective_at timestamptz,
  actor text NOT NULL DEFAULT 'system',
  details_jsonb jsonb,
...
CREATE TABLE IF NOT EXISTS shadow_eval_runs (
  ...
  league_id uuid REFERENCES "League"(id) ON DELETE SET NULL,
  scope_league_key text NOT NULL DEFAULT 'global',
  champion_model_version_id uuid NOT NULL REFERENCES "ModelVersion"(id) ON DELETE CASCADE,
  challenger_model_version_id uuid NOT NULL REFERENCES "ModelVersion"(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS challenger_evaluations (
  ...
  champion_model_version_id uuid NOT NULL REFERENCES "ModelVersion"(id) ON DELETE CASCADE,
  challenger_model_version_id uuid NOT NULL REFERENCES "ModelVersion"(id) ON DELETE CASCADE,
  shadow_eval_run_id uuid REFERENCES shadow_eval_runs(id) ON DELETE SET NULL,
  evaluation_window_start timestamptz NOT NULL,
  evaluation_window_end timestamptz NOT NULL,
  sample_size integer NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS promotion_decisions (
  ...
  champion_model_version_id uuid NOT NULL REFERENCES "ModelVersion"(id) ON DELETE CASCADE,
  challenger_model_version_id uuid NOT NULL REFERENCES "ModelVersion"(id) ON DELETE CASCADE,
  champion_calibration_version_id uuid REFERENCES "PredictionCalibration"(id) ON DELETE SET NULL,
  challenger_calibration_version_id uuid REFERENCES "PredictionCalibration"(id) ON DELETE SET NULL,
  challenger_evaluation_id uuid REFERENCES challenger_evaluations(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS rollback_events (
  ...
  league_id uuid REFERENCES "League"(id) ON DELETE SET NULL,
  scope_league_key text NOT NULL DEFAULT 'global',
  from_model_version_id uuid REFERENCES "ModelVersion"(id) ON DELETE SET NULL,
  to_model_version_id uuid REFERENCES "ModelVersion"(id) ON DELETE SET NULL,
  from_calibration_version_id uuid REFERENCES "PredictionCalibration"(id) ON DELETE SET NULL,
  to_calibration_version_id uuid REFERENCES "PredictionCalibration"(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS serving_alias_history (
  ...
  previous_model_version_id uuid REFERENCES "ModelVersion"(id) ON DELETE SET NULL,
  new_model_version_id uuid REFERENCES "ModelVersion"(id) ON DELETE SET NULL,
  previous_calibration_version_id uuid REFERENCES "PredictionCalibration"(id) ON DELETE SET NULL,
  new_calibration_version_id uuid REFERENCES "PredictionCalibration"(id) ON DELETE SET NULL,
  actor text NOT NULL DEFAULT 'system',
  reason text,
  metadata_jsonb jsonb,
  created_at timestamptz NOT NULL DEFAULT now(),
...
CREATE TABLE IF NOT EXISTS drift_events (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  drift_monitor_id uuid REFERENCES drift_monitors(id) ON DELETE SET NULL,
  sport text NOT NULL,
  market text NOT NULL,
  line double precision,
  line_key text NOT NULL,
