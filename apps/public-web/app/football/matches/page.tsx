        ...
        <div className="relative">
          <div className="mb-3 flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-neon-cyan to-neon-purple">
              <Swords className="h-6 w-6 text-void" />
            </div>
            <div>
              <h1 className="gradient-text font-display text-3xl font-bold">Futbol Maclari</h1>
              <p className="text-sm text-slate-400">Futbol karsilasmalari, skorlar ve mac detaylari</p>
            </div>
          </div>
